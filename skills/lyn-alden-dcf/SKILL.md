...
> **Data source:** For stock/fundamental data, use the `stock-info` skill at `plugins/skills/stock-info/`.
> - `bash plugins/skills/stock-info/tools/get-all.sh <ticker>` — fetch all financials at once
> - `bash plugins/skills/stock-info/tools/get-info.sh <ticker>` — price, shares outstanding, sector
> - `bash plugins/skills/stock-info/tools/get-income-statement.sh <ticker>` — revenue, EPS, margins
> - `bash plugins/skills/stock-info/tools/get-cash-flow.sh <ticker>` — FCF, capex, buybacks
> - `bash plugins/skills/stock-info/tools/get-balance-sheet.sh <ticker>` — cash, debt, net debt
...
- **stock-info skill** at `plugins/skills/stock-info/` provides financial data
